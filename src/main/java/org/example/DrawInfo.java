...
public class DrawInfo {
    ...
    public DrawInfo(){
        ...
        try{
            BufferedImage big_mine_sprite = ImageIO.read(new File("./src/main/resources/Mine.png"));
            BufferedImage big_flag_sprite = ImageIO.read(new File("./src/main/resources/Flag.png"));
